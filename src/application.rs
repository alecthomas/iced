...
impl<P: Program> Application<P> {
    ...
    /// Sets the primary proportional font family of the [`Application`].
    pub fn font_family(mut self, family: impl Into<String>) -> Self {
        self.settings.font_settings.family = Some(family.into());
        self
    }

    /// Sets preferred proportional fallback families of the [`Application`].
    ...
    /// Sets the primary monospaced font family of the [`Application`].
    ...
    /// Sets preferred monospaced fallback families of the [`Application`].
